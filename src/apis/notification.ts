...
export const getUserNotifications = async () => {
      try {
        const response = await authorizedApiClient.get(`${basePath}`, {
          });
          return response.data;
      } catch (error) {
...
export const updateNotification = async (id:string,data:any) => {
    try {
        const response = await authorizedApiClient.patch(`${basePath}/${id}`, data);
        return response.data;
    } catch (error) {
...
export const markNotificationAsRead = async (data:any) => {
    try {
        const response = await authorizedApiClient.patch(`${basePath}/markAsRead`, data);
        return response.data;
    } catch (error) {
        console.error("Error updating notifications:", error);
        throw error; 
