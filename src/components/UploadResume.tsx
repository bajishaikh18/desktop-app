  ...
  return (
    <>
      ...
      <p className={styles.modalDescription}>
        you can upload your cv to find relevant jobs
        <br />
      ...
      <div className={styles.uploadBox}>
        ...
        <p className={styles.uploadDescription}>pdf files only</p>
        <div {...getCvRootProps()} className={styles.dropzone}>
      ...
      <div className={styles.uploadBox}>
        ...
        <div {...getVideoRootProps()} className={styles.dropzone}>
